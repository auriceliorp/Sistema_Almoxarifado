...
def lista_nd():
    ...
    template = 'partials/nd/lista_nd.html' if is_ajax() else 'nd_grupos_ul.html'
...
def nova_nd():
    if request.method == 'POST':
        ...
        db.session.add(nova)
        db.session.commit()
        flash('ND cadastrada com sucesso!')
...
def editar_nd(id):
    ...
    if request.method == 'POST':
        ...
        db.session.commit()
        flash('ND atualizada com sucesso!')
