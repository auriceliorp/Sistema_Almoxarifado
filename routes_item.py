...
@item_bp.route('/item/exportar_pdf') @login_required def exportar_pdf(): nd_id = request.args.get('nd', type=int) if nd_id: itens = Item.query.filter_by(natureza_id=nd_id).all() else: itens = Item.query.all()
